...
// Пожалуйста, обратите внимание: вызов .then прикреплён к fetch, 
// чтобы, когда ответ получен, сразу начинать считывание данных с помощью .json(), 
...
// пока завершатся все из них. Вызывая .json() сразу после каждого fetch, мы добились того, 
// что считывание присланных по каждому запросу данных происходит независимо от других запросов.
